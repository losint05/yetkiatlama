...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    ${currentRank ? `**───────────────** 
    Genel Puan Durumu (\`Atlamaya uygun değil!\`)
    ${conf.nokta} Ceza Durumu: \`0 (Ceza Etkisi: Yok!)\`
    ${conf.nokta} Taglı Puan: \`${taggedData.taggeds.length}\`
    ...
    **${terfiemoji} Yetki Durumu:** 
    ...
    ${message.author.toString()} (${message.member.roles.highest}) kişisinin yetki yükseltim bilgileri aşağıda belirtilmiştir
